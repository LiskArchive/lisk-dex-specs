...
This LIP describes the configuration of the Lisk DEX v1 blockchain, including the selection of modules, the choice of configurable constants and the genesis block.
...
The motivation for this LIP is to define the modules, configurable constants and genesis block of the Lisk DEX v1 blockchain and to have one document linking to all relevant specifications for the Lisk DEX v1 blockchain.
...
This LIP describes the configuration and protocol for a new blockchain. Hence, backwards compatibility is not relevant.
...
[dex-module]: https://github.com/LiskHQ/lips-staging/blob/main/proposals/lip-introduce_DEX_Module.md
[dex-module#genesis-assets-schema]: https://github.com/LiskHQ/lips-staging/blob/main/proposals/lip-introduce_DEX_Module.md#genesis-assets-schema
[dex-module#notation-and-constants]: https://github.com/LiskHQ/lips-staging/blob/main/proposals/lip-introduce_DEX_Module.md#notation-and-constants
[dex-incentives-module]: https://github.com/LiskHQ/lips-staging/blob/main/proposals/lip_introduce_DEX_Rewards_module.md
[dex-incentives-module#notation-and-constants]: https://github.com/LiskHQ/lips-staging/blob/main/proposals/lip_introduce_DEX_Rewards_module.md#notation-and-constants
[dex-governance-module]: https://github.com/LiskHQ/lips-staging/blob/main/proposals/lip_introduce_DEX_Governance_module.md
[dex-governance-module#notation-and-constants]: https://github.com/LiskHQ/lips-staging/blob/main/proposals/lip_introduce_DEX_Governance_module.md#notation-and-constants
