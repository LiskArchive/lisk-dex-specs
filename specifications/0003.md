...
Together with "Introduce DEX module" and "LPs" specifications, these specifications completely specifies the DEX module.
...
where the functions `getToken0Id`, `getToken1Id`, `transferToPool`, `transferPoolToPool`, and `transferFromPool` are defined in the [Introduce DEX module specifications][dexmodule].
