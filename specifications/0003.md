...
These specifications, together with the ["Introduce DEX module" specifications][dexmodule] and ["Define liquidity provider interactions for DEX module"][liquidityprovision], introduce a new module with its dedicated module store and commands. Adding this module to an existing blockchain therefore requires a hardfork.
...
[liquidityprovision]: https://github.com/LiskHQ/lisk-dex-specs/blob/main/specifications/0002.md
